...
public class TaipeiMapsActivity extends AppCompatActivity implements OnMapReadyCallback {
        ...
        td_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (currentLocation != null) {
                    ...
                    if(distwaring<dist) {
                        if (distwaring <= 100) {
                            new AlertDialog.Builder(TaipeiMapsActivity.this)
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                ...
                if (location != null) {
                    ...
                    supportMapFragment.getMapAsync(TaipeiMapsActivity.this);
                }

            }
        });
    }
    private final int LOCATION_UPDATE_INTERVAL = 3000; // 更新间隔时间，单位为毫秒
    private final int ALERT_COOLDOWN_TIME = 20000; // 冷却时间，单位为毫秒
    ...
    private Runnable locationUpdateRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (currentLocation != null) {
                ...
                if(distwaring<dist && (currentTimeMillis - lastAlertTime > ALERT_COOLDOWN_TIME)) {
                ...
                else if (distwaring>=dist&& (currentTimeMillis - lastAlertTime > ALERT_COOLDOWN_TIME)) {
                    lastAlertTime= currentTimeMillis;
                    new AlertDialog.Builder(TaipeiMapsActivity.this)
                            .setIcon(R.drawable._291745)
                            .setTitle("你目前在安全水域")
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions markerOptions = new MarkerOptions().position(latLng).title("目前所在位置");
        // 先清除之前的标记
        if (marker1 != null) {
            marker1.remove();
        }
        ...
        // 添加固定点的标记
        LatLng fixedLocation = new LatLng(25.021858015926703, 121.53529975334598);
        MarkerOptions fixedMarkerOptions = new MarkerOptions()
                .position(fixedLocation)
                .title("安全地點"); // 自定义标记的标题
        googleMap.addMarker(fixedMarkerOptions);
        LatLng fixedLocationwaring = new LatLng(25.020468996722776,  121.5376966266158);
